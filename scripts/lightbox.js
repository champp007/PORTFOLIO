  ...
  (function($) {
    ...
    $(document).ready(function() {
      var $body = $("body"),
        ...
        modalOpen = false,
        $ajaxPages = $(".list-pages")
          .find("a")
          .not('[data-link-type="page-redirect"]'),
      ...
      function initEvents() {
        ...
        $modal[0].addEventListener("click", function(ev) {
          ...
          if (
            modalOpen &&
            target !== $modalContent[0] &&
            !$(target).parents("#modal-content").length
          ) {
            history.pushState(null, null, "/");
            closeModal();
          }
      ...
      $(window).on("popstate", function(e) {
        ...
        if (returnLocation.pathname != "/") {
          var $link = $ajaxPortfolio.find(
            '.project a[href="' + returnLocation.href + '"]'
          );
